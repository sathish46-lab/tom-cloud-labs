        ...
        <div class="card shadow-lg rounded-4 p-3 border-0 glass-card h-100">
            <div class="mb-3">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <span class="badge bg-secondary-gradient rounded-pill fw-bold" style="font-size: 10px; padding: 3px 8px;"><?= strtoupper($label) ?></span>
                </div>
                
                <span class="badge rounded-pill <?= $isAllocated ? 'bg-success' : 'bg-danger' ?> opacity-90 fw-bold" style="font-size: 10px; padding: 3px 8px;">
