        ...
        <div class="card shadow-lg rounded-4 overflow-hidden border-0">
            <div class="card-body p-4">
                ...
                <div class="d-flex gap-2 mb-3">
                    ...
                    ?>
                    <span class="badge rounded-pill <?= $typeClass ?> px-2 py-1 d-flex align-items-center">
                        <i class='bx <?= $typeIcon ?> me-1'></i> <?= ucfirst($type) ?>
                    </span>
                    <?php 
                    ...
                    ?>
                    <span class="badge rounded-pill small status-pill <?= $statusClass ?> px-2 py-1 d-flex align-items-center">
                        <i class='bx <?= $statusIcon ?> me-1'></i> <?= $displayStatus ?>
                    </span>
                </div>
