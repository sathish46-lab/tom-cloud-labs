                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4" style="background-color: var(--cui-card-bg);">
                    ...
                    <div class="card-body px-4 pb-4">
                        <div class="mb-3">
                            ...
                            <select id="select-db-user" class="form-select bg-dark text-white border-0 shadow-none" style="border-radius: 8px; cursor: pointer;" onchange="switchMySQLUser(this.value)">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="new-db-collation" class="form-select bg-dark text-white border-0 shadow-none" style="border-radius: 8px; cursor: pointer;">
                                        ...
                                        <div class="card simple-whitebg h-100">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between align-items-start mb-3">
                                                    <div>
                                                        <div class="text-medium-emphasis small  fw-semibold mb-1">Database</div>
                                                        <h6 class="card-title mb-0"><?= htmlspecialchars($dbObj['db_name']) ?></h6>
                                                    </div>
                                                    <span class="badge bg-light text-dark mysql-collation text-lowercase"><?= htmlspecialchars($dbObj['collation'] ?? 'utf8mb4_0900_ai_ci') ?></span>
                                                </div>
