                ...
                <div class="card-body px-4 pb-4">
                    ...
                    <div class="mb-3 d-flex justify-content-between align-items-center bg-dark bg-opacity-50 p-2 px-3 rounded border border-light border-opacity-10">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <i class='bx bx-copy text-secondary cursor-pointer hover-white' data-copy="rabbitmq.selfmade.ninja"></i>
                        </div>
                    </div>
                    <div class="mb-0 d-flex justify-content-between align-items-center bg-dark bg-opacity-50 p-2 px-3 rounded border border-light border-opacity-10">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <i class='bx bx-copy text-secondary cursor-pointer hover-white' data-copy="5672"></i>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="card-body p-3 d-flex flex-column">
                                            <div class="mb-3">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center bg-dark bg-opacity-50 p-2 rounded mt-1 border border-light border-opacity-10">
                                                    ...
                                                    <i class='bx bx-copy text-secondary cursor-pointer hover-white' data-copy="<?= htmlspecialchars($mu['rabbitmq_username']) ?>"></i>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center bg-dark bg-opacity-50 p-2 rounded mt-1 border border-light border-opacity-10">
                                                    ...
                                                    <div>
                                                        ...
                                                        <i class='bx bx-copy text-secondary cursor-pointer hover-white' data-copy="<?= htmlspecialchars(base64_decode($mu['rabbitmq_password'])) ?>"></i>
                                                    </div>
                                                </div>
                                            </div>
