...
<div class="card blur border-0 rounded-4 p-4 shadow-lg">
    ...
    <div class="d-flex align-items-center justify-content-between border-bottom border-secondary border-opacity-25 pb-2 mb-4">
        <span class="text-secondary fw-bold small text-uppercase">DEPLOYMENTS <span class="badge bg-primary text-white rounded-pill fw-bold ms-2">running <?= count($instance['deployments'] ?? []) ?></span></span>
