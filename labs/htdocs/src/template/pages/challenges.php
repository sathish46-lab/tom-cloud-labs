                            ...
                            <div class="d-flex justify-content-between align-items-center w-100 mt-1">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="d-flex gap-2 ms-1">
                                        <i class='bx bx-info-circle text-white-50 pointer transition-all hover-text-white' style="font-size: 0.9rem;" data-coreui-toggle="tooltip" title="<?= $isRunning ? 'Hash: ' . htmlspecialchars($instanceHash) : 'Instance Not Running' ?>" <?= $isRunning ? "data-copy=\"".htmlspecialchars($instanceHash)."\"" : "onclick=\"TomNotify.show('Start the lab to view its hash.', 'Notice', 'warning');\"" ?>></i>
                                        <i class='bx bx-copy text-white-50 pointer transition-all hover-text-white' style="font-size: 0.9rem;" data-coreui-toggle="tooltip" title="Copy Lab ID" data-copy="<?= htmlspecialchars($c['lab_id']) ?>"></i>
                                        <i class='bx bx-share-alt text-white-50 pointer transition-all hover-text-white' style="font-size: 0.9rem;" data-coreui-toggle="tooltip" title="Share Lab" data-copy="<?= htmlspecialchars((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . '/challenges/dashboard/' . $c['lab_id']) ?>"></i>
                                    </div>
                                </div>
