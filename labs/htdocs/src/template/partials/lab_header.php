    ...
    <div class="container-fluid p-0">
        <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex flex-column gap-1">
                    ...
                    <div class="d-flex align-items-center gap-3 small">
                        <div class="d-flex align-items-center text-secondary opacity-75">
                            ...
                            <button class="btn btn-link btn-sm p-0 ms-1 text-secondary hover-text-white clipboard" data-clipboard-text="<?= $labType ?>">
                        ...
                        <!-- Share Link -->
                        <div class="d-flex align-items-center text-secondary opacity-75">
                            <button class="btn btn-link btn-sm p-0 text-secondary hover-text-white clipboard text-decoration-none d-flex align-items-center gap-1" 
                                    data-clipboard-text="https://<?= $_SERVER['HTTP_HOST'] ?>/labs/domains/<?= $fullHash ?>"
            ...
            <div class="btn-group shadow-lg rounded-pill overflow-hidden" role="group">
                ...
                <?php if($isRunning): ?>
                    <button id="btn-stop-action" class="btn btn-danger btn-stop-lab px-4 py-2 fw-bold hover-scale border-0 d-flex align-items-center gap-2" 
                            onclick="handleStop()"
                            data-coreui-toggle="tooltip" title="Stop Instance"
                            data-coreui-toggle="loading-button" data-coreui-spinner-type="grow">
                        <svg class="icon"><use xlink:href="/assets/icons/free.svg#cil-media-stop"></use></svg>
                        <span>Stop</span>
                    </button>
                <?php endif; ?>
            </div>
