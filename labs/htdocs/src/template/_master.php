...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= Session::cacheCDN('/assets/logo/favicon.png') ?>">
    <link rel="shortcut icon" type="image/png" href="<?= Session::cacheCDN('/assets/logo/favicon.png') ?>">
